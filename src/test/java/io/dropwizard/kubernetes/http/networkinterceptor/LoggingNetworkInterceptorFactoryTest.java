...
public class LoggingNetworkInterceptorFactoryTest {
    ...
    public void isDiscoverable() {
        assertThat(new DiscoverableSubtypeResolver().getDiscoveredSubtypes()).contains(LoggingNetworkInterceptorFactory.class);
    }

    @Test
    public void shouldBuildAUserAgentNetworkInterceptor() throws Exception {
        // given
        final File yaml = new File(Resources.getResource("yaml/http/networkinterceptor/logging.yaml").toURI());
        ...
        // then
        assertThat(networkInterceptorFactory).isInstanceOf(LoggingNetworkInterceptorFactory.class);
